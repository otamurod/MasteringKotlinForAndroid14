...
import uz.otamurod.chapter09.data.PermissionAction
...
fun PermissionDialog(
    ...
    var isDialogDismissed by remember { mutableStateOf(false) } // used to check whether the dialog has been dismissed
    var isPristine by remember { mutableStateOf(true) } // used to know whether the dialog was shown before
